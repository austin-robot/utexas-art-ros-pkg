...
# normally appended to .bashrc.  The EOF is quoted, so none of the
# lines that follow will be expanded.
cat <<'EOF'
...
export ROS_STACK_PATH=$ROS_ROOT:$HOME/ros/pkgs:$HOME/svn/utexas-art-ros-pkg
